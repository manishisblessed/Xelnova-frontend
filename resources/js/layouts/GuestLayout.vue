...
<template>
    <div class="flex flex-wrap" :class="{ dark: styleStore.darkMode }">
        ...
        >
            <div
                class="flex items-center justify-center text-2xl uppercase text-white dark:text-black lg:text-9xl lg:h-screen lg:bg-[url('/images/banner.jpg')] bg-no-repeat bg-cover lg:-indent-[500%]"
            >
                NeonFlow
            </div>
        </div>
