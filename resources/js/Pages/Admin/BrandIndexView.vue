                ...
                >
                    ...
                    <template #cell(logo_url)="{ item }">
                        <div class="flex items-center justify-center">
                            <img v-if="item.logo_url" :src="item.logo_url" class="w-12 h-12 object-contain rounded bg-white p-1 shadow-sm border border-gray-200 dark:border-gray-600" />
                            <span v-else class="text-gray-400 italic text-xs">No logo</span>
                        </div>
                    </template>
